(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var DefaultLinkHandler = function (_super) {
    ...
    DefaultLinkHandler.getEventInfo = function (event) {
      ...
      if (hasAttribute$1(target, 'download') || hasAttribute$1(target, 'router-ignore') || hasAttribute$1(target, 'data-router-ignore')) {
        return info;
      }
  ...
  var hasAttribute$1 = function hasAttribute(el, attr) {
  ...
  function () {
    ...
    _proto.get = function get(charSpec) {
    ...
    _proto.put = function put(charSpec) {
    ...
    _proto.match = function match(ch) {
  ...
  function () {
    ...
    var _proto2 = StaticSegment.prototype;

    _proto2.eachChar = function eachChar(callback) {
      var s = this.string;
  ...
  function () {
    ...
    var _proto3 = DynamicSegment.prototype;

    _proto3.eachChar = function eachChar(callback) {
      callback({
        invalidChars: '/',
        repeat: true
      });
    ...
    _proto3.regex = function regex() {
      return '([^/]+)';
    };

    _proto3.generate = function generate(params, consumed) {
  ...
  function () {
    ...
    var _proto4 = StarSegment.prototype;

    _proto4.eachChar = function eachChar(callback) {
      callback({
        invalidChars: '',
        repeat: true
      });
    ...
    _proto4.regex = function regex() {
      return '(.+)';
    };

    _proto4.generate = function generate(params, consumed) {
      consumed[this.name] = true;
      return params[this.name];
    };
  ...
  function () {
    ...
    var _proto5 = EpsilonSegment.prototype;

    _proto5.eachChar = function eachChar() {};

    _proto5.regex = function regex() {
      return '';
    };

    _proto5.generate = function generate() {
      return '';
    };
  ...
  function () {
    ...
    var _proto6 = RouteRecognizer.prototype;

    _proto6.add = function add(route) {
      var _this = this;
    ...
    _proto6.getRoute = function getRoute(nameOrRoute) {
      return typeof nameOrRoute === 'string' ? this.names[nameOrRoute] : this.routes.get(nameOrRoute);
    };

    _proto6.handlersFor = function handlersFor(nameOrRoute) {
    ...
    _proto6.hasRoute = function hasRoute(nameOrRoute) {
      return !!this.getRoute(nameOrRoute);
    };

    _proto6.generate = function generate(nameOrRoute, params) {
      var route = this.getRoute(nameOrRoute);
    ...
    _proto6.recognize = function recognize(path) {
  ...
  function () {
    ...
    var _proto = NavigationInstruction.prototype;

    _proto.getAllInstructions = function getAllInstructions() {
    ...
    _proto.getAllPreviousInstructions = function getAllPreviousInstructions() {
    ...
    _proto.addViewPortInstruction = function addViewPortInstruction(nameOrInitOptions, strategy, moduleId, component) {
    ...
    _proto.getWildCardName = function getWildCardName() {
    ...
    _proto.getWildcardPath = function getWildcardPath() {
    ...
    _proto._commitChanges = function _commitChanges(waitToSwap) {
      var _this2 = this;
    ...
    _proto._updateTitle = function _updateTitle() {
      var router = this.router;
    ...
    _proto._buildTitle = function _buildTitle(separator) {
      if (separator === void 0) {
        separator = ' | ';
      }
  ...
  var prune = function prune(instruction) {
  ...
  */
  ...
  function () {
    ...
    */
    ...
    var _proto2 = NavModel.prototype;
  ...
  function () {
    ...
    var _proto3 = RouterConfiguration.prototype;

    _proto3.addPipelineStep = function addPipelineStep(name, step) {
    ...
    _proto3.addAuthorizeStep = function addAuthorizeStep(step) {
    ...
    _proto3.addPreActivateStep = function addPreActivateStep(step) {
    ...
    _proto3.addPreRenderStep = function addPreRenderStep(step) {
    ...
    _proto3.addPostRenderStep = function addPostRenderStep(step) {
    ...
    _proto3.fallbackRoute = function fallbackRoute(fragment) {
    ...
    _proto3.map = function map(route) {
      var _this3 = this;
    ...
    _proto3.useViewPortDefaults = function useViewPortDefaults(viewPortConfig) {
    ...
    _proto3.mapRoute = function mapRoute(config) {
    ...
    _proto3.mapUnknownRoutes = function mapUnknownRoutes(config) {
    ...
    _proto3.exportToRouter = function exportToRouter(router) {
      var instructions = this.instructions;
      ...
      var title = this.title,
          ...
          unknownRouteConfig = this.unknownRouteConfig,
          _fallbackRoute = this._fallbackRoute,
          viewPortDefaults = this.viewPortDefaults;
      ...
      if (pipelineStepCount) {
        ...
        for (var _i = 0, _ii = pipelineStepCount; _i < _ii; ++_i) {
          var _pipelineSteps$_i = pipelineSteps[_i],
              name = _pipelineSteps$_i.name,
  ...
  function () {
    ...
    function Router(container, history) {
      ...
      this.transformTitle = function (title) {
        if (_this4.parent) {
          return _this4.parent.transformTitle(title);
        }
    ...
    _proto4.reset = function reset() {
      ...
      this._configuredPromise = new Promise(function (resolve) {
        _this5._resolveConfiguredPromise = resolve;
      });
    }
    /**
     ...
     */
    _proto4.registerViewPort = function registerViewPort(viewPort, name) {
      name = name || 'default';
    ...
    _proto4.ensureConfigured = function ensureConfigured() {
    ...
    _proto4.configure = function configure(callbackOrConfig) {
      var _this6 = this;
      ...
      return Promise.resolve(result).then(function (c) {
        ...
        config.exportToRouter(_this6);
        _this6.isConfigured = true;

        _this6._resolveConfiguredPromise();
      });
    }
    /**
    ...
    _proto4.navigate = function navigate(fragment, options) {
    ...
    _proto4.navigateToRoute = function navigateToRoute(route, params, options) {
    ...
    _proto4.navigateBack = function navigateBack() {
    ...
    _proto4.createChild = function createChild(container) {
    ...
    _proto4.generate = function generate(nameOrRoute, params, options) {
      if (params === void 0) {
        params = {};
      }
    ...
    _proto4.createNavModel = function createNavModel(config) {
    ...
    _proto4.addRoute = function addRoute(config, navModel) {
      if (Array.isArray(config.route)) {
    ...
    _proto4.hasRoute = function hasRoute(name) {
    ...
    _proto4.hasOwnRoute = function hasOwnRoute(name) {
    ...
    _proto4.handleUnknownRoutes = function handleUnknownRoutes(config) {
      var _this7 = this;
      ...
      this.catchAllHandler = function (instruction) {
        return _this7._createRouteConfig(config, instruction).then(function (c) {
    ...
    _proto4.updateTitle = function updateTitle() {
    ...
    _proto4.refreshNavigation = function refreshNavigation() {
    ...
    _proto4.useViewPortDefaults = function useViewPortDefaults($viewPortDefaults) {
    ...
    _proto4._refreshBaseUrl = function _refreshBaseUrl() {
      var parentRouter = this.parent;
    ...
    _proto4._createNavigationInstruction = function _createNavigationInstruction(url, parentInstruction) {
      if (url === void 0) {
        url = '';
      }
      ...
      if (urlRecognizationResults && urlRecognizationResults.length) {
        ...
        result = evaluateNavigationStrategy(_instruction, this.catchAllHandler);
      } else if (this.parent) {
        ...
        if (router) {
          ...
          result = evaluateNavigationStrategy(_instruction2, router.catchAllHandler);
        }
      }
    ...
    _proto4._findParentInstructionFromRouter = function _findParentInstructionFromRouter(router, instruction) {
    ...
    _proto4._parentCatchAllHandler = function _parentCatchAllHandler(router) {
    ...
    _proto4._createRouteConfig = function _createRouteConfig(config, instruction) {
      var _this8 = this;
      ...
      .then(function (c) {
        ...
        if (!c.navModel) {
          c.navModel = _this8.createNavModel(c);
        }
  ...
  var generateBaseUrl = function generateBaseUrl(router, instruction) {
    return "" + (router.baseUrl || '') + (instruction.getBaseUrl() || '');
  };
  /* @internal exported for unit testing */


  var validateRouteConfig = function validateRouteConfig(config) {
  ...
  var evaluateNavigationStrategy = function evaluateNavigationStrategy(instruction, evaluator, context) {
  ...
  var createNextFn = function createNextFn(instruction, steps) {
    var index = -1;
  ...
  var createCompletionHandler = function createCompletionHandler(next, status) {
  ...
  function () {
    ...
    var _proto5 = Pipeline.prototype;

    _proto5.addStep = function addStep(step) {
      var run;
    ...
    _proto5.run = function run(instruction) {
  ...
  */
  ...
  function () {
    ...
    var _proto6 = Redirect.prototype;

    _proto6.setRouter = function setRouter(router) {
      this.router = router;
    }
    /**
    ...
    _proto6.navigate = function navigate(appRouter) {
  ...
  function () {
    ...
    var _proto7 = RedirectToRoute.prototype;

    _proto7.setRouter = function setRouter(router) {
      this.router = router;
    }
    /**
     * Called by the navigation pipeline to navigate.
    ...
    _proto7.navigate = function navigate(appRouter) {
      var navigatingRouter = this.options.useAppRouter ? appRouter : this.router || appRouter;
  ...
  var buildRedirectPlan = function buildRedirectPlan(instruction) {
    var config = instruction.config;
    ...
    return router._createNavigationInstruction(config.redirect).then(function (redirectInstruction) {
      ...
      for (var _key in originalInstructionParams) {
        redirectLocation = redirectLocation.replace(":" + _key, originalInstructionParams[_key]);
      }
  ...
  var buildTransitionPlans = function buildTransitionPlans(currentInstruction, previousInstruction, defaultViewPortConfigs, forceLifecycleMinimum) {
    var viewPortPlans = {};
  ...
  var determineActivationStrategy = function determineActivationStrategy(currentNavInstruction, prevViewPortInstruction, newViewPortConfig, // indicates whether there is difference between old and new url params
  ...
  var hasDifferentParameterValues = function hasDifferentParameterValues(prev, next) {
    ...
    for (var _key3 in nextQueryParams) {
      if (prevQueryParams[_key3] !== nextQueryParams[_key3]) {
        return true;
      }
    }

    for (var _key4 in prevQueryParams) {
  ...
  function () {
    ...
    var _proto8 = BuildNavigationPlanStep.prototype;

    _proto8.run = function run(navigationInstruction, next) {
  ...
  var loadNewRoute = function loadNewRoute(routeLoader, navigationInstruction) {
  ...
  var determineLoadingPlans = function determineLoadingPlans(navigationInstruction, loadingPlans) {
  ...
  var loadRoute = function loadRoute(routeLoader, navigationInstruction, viewPortPlan) {
  ...
  var loadComponent = function loadComponent(routeLoader, navigationInstruction, config) {
    ...
    function (component) {
      ...
      if ('configureRouter' in viewModel) {
        ...
        return childRouter.configure(function (c) {
          return viewModel.configureRouter(c, childRouter, lifecycleArgs[0], lifecycleArgs[1], lifecycleArgs[2]);
        }).then(function () {
          return component;
        });
      }
  ...
  function () {
    ...
    var _proto9 = RouteLoader.prototype;
    ...
    _proto9.loadRoute = function loadRoute(router, config, navigationInstruction) {
  ...
  function () {
    ...
    var _proto10 = LoadRouteStep.prototype;

    _proto10.run = function run(navigationInstruction, next) {
  ...
  function () {
    ...
    var _proto11 = CommitChangesStep.prototype;

    _proto11.run = function run(navigationInstruction, next) {
  ...
  var processDeactivatable = function processDeactivatable(navigationInstruction, callbackName, next, ignoreResult) {
  ...
  var findDeactivatable = function findDeactivatable(plan, callbackName, list) {
    if (list === void 0) {
      list = [];
    }
  ...
  var addPreviousDeactivatable = function addPreviousDeactivatable(component, callbackName, list) {
    var childRouter = component.childRouter;
  ...
  var processActivatable = function processActivatable(navigationInstruction, callbackName, next, ignoreResult) {
    ...
    function iterate() {
      ...
      if (i < length) {
        try {
          ...
          var result = (_current3$viewModel = _current3.viewModel)[callbackName].apply(_current3$viewModel, _current3.lifecycleArgs);
  ...
  var findActivatable = function findActivatable(navigationInstruction, callbackName, list, router) {
    if (list === void 0) {
      list = [];
    }
  ...
  var shouldContinue = function shouldContinue(output, router) {
  ...
  function () {
    ...
    var _proto12 = SafeSubscription.prototype;

    _proto12.unsubscribe = function unsubscribe() {
  ...
  var processPotential = function processPotential(obj, resolve, reject) {
    // if promise like
  ...
  function () {
    ...
    var _proto13 = CanDeactivatePreviousStep.prototype;

    _proto13.run = function run(navigationInstruction, next) {
  ...
  function () {
    ...
    var _proto14 = CanActivateNextStep.prototype;

    _proto14.run = function run(navigationInstruction, next) {
  ...
  function () {
    ...
    var _proto15 = DeactivatePreviousStep.prototype;

    _proto15.run = function run(navigationInstruction, next) {
  ...
  function () {
    ...
    var _proto16 = ActivateNextStep.prototype;

    _proto16.run = function run(navigationInstruction, next) {
  ...
  function () {
    ...
    var _proto17 = PipelineSlot.prototype;

    _proto17.getSteps = function getSteps() {
      var _this9 = this;

      return this.steps.map(function (x) {
        return _this9.container.get(x);
      });
    };
  ...
  function () {
    ...
    var _proto18 = PipelineProvider.prototype;

    _proto18.createPipeline = function createPipeline(useCanDeactivateStep) {
      var _this10 = this;
      ...
      this.steps.forEach(function (step) {
        if (useCanDeactivateStep || step !== CanDeactivatePreviousStep) {
          pipeline.addStep(_this10.container.get(step));
        }
      });
      return pipeline;
    }
    ...
    _proto18._findStep = function _findStep(name) {
    ...
    _proto18.addStep = function addStep(name, step) {
    ...
    _proto18.removeStep = function removeStep(name, step) {
    ...
    _proto18._clearSteps = function _clearSteps(name) {
      if (name === void 0) {
        name = '';
      }
  ...
  var createPipelineSlot = function createPipelineSlot(container, name, alias) {
    return new PipelineSlot(container, name, alias);
  };

  var logger$4 = getLogger('app-router');
  /**
  ...
  /*#__PURE__*/
  function (_Router) {
    _inheritsLoose(AppRouter, _Router);
    ...
    function AppRouter(container, history, pipelineProvider, events) {
      ...
      _this11 = _Router.call(this, container, history) || this; // Note the super will call reset internally.

      _this11.pipelineProvider = pipelineProvider;
      _this11.events = events;
      return _this11;
    }
    /**
     * Fully resets the router's internal state. Primarily used internally by the framework when multiple calls to setRoot are made.
    ...
    var _proto19 = AppRouter.prototype;
    ...
    _proto19.loadUrl = function loadUrl(url) {
      var _this12 = this;

      return this._createNavigationInstruction(url).then(function (instruction) {
        return _this12._queueInstruction(instruction);
    ...
    _proto19.registerViewPort = function registerViewPort(viewPort, name) {
      var _this13 = this;

      // having strong typing without changing public API
      var $viewPort = viewPort;

      _Router.prototype.registerViewPort.call(this, $viewPort, name); // beside adding viewport to the registry of this instance
        ...
        if ('configureRouter' in viewModel) {
          ...
          if (!this.isConfigured) {
            ...
            return this.configure(function (config) {
              return Promise.resolve(viewModel.configureRouter(config, _this13)) // an issue with configure interface. Should be fixed there
    ...
    _proto19.activate = function activate(options) {
      if (this.isActive) {
        return;
      }
    ...
    _proto19.deactivate = function deactivate() {
      this.isActive = false;
    ...
    _proto19._queueInstruction = function _queueInstruction(instruction) {
      var _this14 = this;

      return new Promise(function (resolve) {
        instruction.resolve = resolve;

        _this14._queue.unshift(instruction);

        _this14._dequeueInstruction();
      });
    }
    /**@internal */
    ;

    _proto19._dequeueInstruction = function _dequeueInstruction(instructionCount) {
      var _this15 = this;
      ...
      return Promise.resolve().then(function () {
        if (_this15.isNavigating && !instructionCount) {
          // ts complains about inconsistent returns without void 0
          return void 0;
        }

        var instruction = _this15._queue.shift();

        _this15._queue.length = 0;
        ...
        _this15.isNavigating = true;

        var navtracker = _this15.history.getState('NavigationTracker');

        var currentNavTracker = _this15.currentNavigationTracker;

        if (!navtracker && !currentNavTracker) {
          _this15.isNavigatingFirst = true;
          _this15.isNavigatingNew = true;
        } else if (!navtracker) {
          _this15.isNavigatingNew = true;
        } else if (!currentNavTracker) {
          _this15.isNavigatingRefresh = true;
        } else if (currentNavTracker < navtracker) {
          _this15.isNavigatingForward = true;
        } else if (currentNavTracker > navtracker) {
          _this15.isNavigatingBack = true;
        }

        if (!navtracker) {
          navtracker = Date.now();

          _this15.history.setState('NavigationTracker', navtracker);
        }

        _this15.currentNavigationTracker = navtracker;
        instruction.previousInstruction = _this15.currentInstruction;
        var maxInstructionCount = _this15.maxInstructionCount;

        if (!instructionCount) {
          _this15.events.publish("router:navigation:processing"
          /* Processing */
          , {
          ...
          restorePreviousLocation(_this15);
          return _this15._dequeueInstruction(instructionCount + 1);
        } else if (instructionCount > maxInstructionCount) {
          throw new Error('Maximum navigation attempts exceeded. Giving up.');
        }

        var pipeline = _this15.pipelineProvider.createPipeline(!_this15.couldDeactivate);

        return pipeline.run(instruction).then(function (result) {
          return processResult(instruction, result, instructionCount, _this15);
        })["catch"](function (error) {
          return {
            output: error instanceof Error ? error : new Error(error)
          };
        }).then(function (result) {
          return resolveInstruction(instruction, result, !!instructionCount, _this15);
        });
      });
    }
    /**@internal */
    ...
    _proto19._findViewModel = function _findViewModel(viewPort) {
  ...
  var processResult = function processResult(instruction, result, instructionCount, router) {
  ...
  var resolveInstruction = function resolveInstruction(instruction, result, isInnerInstruction, router) {
  ...
  var restorePreviousLocation = function restorePreviousLocation(router) {
  ...
  */
  ...
  var EmptyLayoutViewModel = function EmptyLayoutViewModel() {};
  /**
  ...
  function () {
    ...
    _proto.process = function process($viewPortInstruction, waitToSwap) {
      var _this = this;
    ...
    _proto.swap = function swap($viewPortInstruction) {
      var _this2 = this;
      ...
      var ready = function ready(owningView_or_layoutView) {
        viewPortController.automate(_this2.overrideContext, owningView_or_layoutView);
        var transactionOwnerShipToken = _this2.compositionTransactionOwnershipToken; // if this router-view is the root <router-view/> of a normal startup via aurelia.setRoot
      ...
      if (layoutInstruction) {
        ...
        .createController(layoutInstruction).then(function (layoutController) {
          ...
          ShadowDOM.distributeView(viewPortController.view, layoutController.slots || layoutView.slots); // when there is a layout
          // view hierarchy is: <router-view/> owner view -> layout view -> ViewPortComponent view

          layoutController.automate(createOverrideContext(layoutInstruction.viewModel), _this2.owningView);
  ...
  */
  ...
  function () {
    ...
    */
    ...
    var _proto2 = RouterViewLocator.prototype;

    _proto2.findNearest = function findNearest() {
      return this.promise;
    }
    /**@internal */
    ;

    _proto2._notify = function _notify(routerView) {
  ...
  function (_RouteLoader) {
    _inheritsLoose(TemplatingRouteLoader, _RouteLoader);

    function TemplatingRouteLoader(compositionEngine) {
      var _this4;

      _this4 = _RouteLoader.call(this) || this;
    ...
    var _proto3 = TemplatingRouteLoader.prototype;

    _proto3.resolveViewModel = function resolveViewModel(router, config) {
      return new Promise(function (resolve, reject) {
        var viewModel;
    ...
    _proto3.createChildContainer = function createChildContainer(router) {
    ...
    _proto3.loadRoute = function loadRoute(router, config, _navInstruction) {
      var _this5 = this;

      return this.resolveViewModel(router, config).then(function (viewModel) {
        return _this5.compositionEngine.ensureViewModel({
          viewModel: viewModel,
          childContainer: _this5.createChildContainer(router),
  ...
  function createDynamicClass(moduleId) {
    ...
    function () {
      ...
      var _proto4 = DynamicClass.prototype;

      _proto4.bind = function bind(bindingContext) {
        this.$parent = bindingContext;
      };
  ...
  var logger$5 = getLogger('route-href');
  /**
  ...
  function () {
    ...
    var _proto5 = RouteHref.prototype;

    _proto5.bind = function bind() {
      this.isActive = true;
      this.processChange();
    };

    _proto5.unbind = function unbind() {
      this.isActive = false;
    };

    _proto5.attributeChanged = function attributeChanged(value, previous) {
      if (previous) {
    ...
    _proto5.processChange = function processChange() {
      var _this6 = this;
      ...
      return this.router.ensureConfigured().then(function () {
        ...
        var element = _this6.element;

        var href = _this6.router.generate(_this6.route, _this6.params);

        if (element.au.controller) {
          element.au.controller.viewModel[_this6.attribute] = href;
        } else {
          element.setAttribute(_this6.attribute, href);
        } // returning null to avoid Bluebird warning
